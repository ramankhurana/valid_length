...
@register_validator(name="guardrails/valid_length", data_type=["string", "list"])
    ...
    def validate(self, value: Union[str, List], metadata: Dict) -> ValidationResult:
        ...
        if self._min is not None and len(value) < self._min:
            ...
            if isinstance(value, str):
                ...
                corrected_value = [v for v in (value or [])]
                corrected_value.extend([last_val] * (self._min - len(value)))
